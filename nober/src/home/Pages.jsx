      ...
      <div className='md:grid md:grid-cols-3 gap-2 w-full md:space-y-0 ml-10 md:ml-0 space-y-2 '>
        ...
        <div className='wel bg-purple-900 w-8/12 h-[18rem]'>
          <Link to='/members'>
            ...
            <div className='flex p-1 justify-start space-x-2 border hover:text-neutral-300 bg-green-400 md:text-lg font-bold items-align bg-purple-900 text-neutral-400'>
            ...
            <div className='flex justify-start mt-6 hover:text-neutral-200 space-x-1 text- font-bold items-align bg-purple-700 text-neutral-400'>
        ...
        <motion.div
          ...
          <Link to='/contributions'>
            ...
            <div>
              ...
              <div className='font-bold text-neutral-300 m-1 mt-6 flex  justify-center space-x-2 bg-green-600 h-7 rounded text-center'>Ongoing Donations
        ...
        <motion.div
          ...
          <div className='list-disc p-2 mb-1 md:mb-3 text-sm space-y-2 font-bold text-neutral-200'>
            <li>Accountability</li>
            <li>No handling of Cash</li>
            <li>Access to financial Records</li>
            <li>Efficient Management</li>
          </div>
          <div className='font-bold flex text-neutral-300 font-bold justify-center  mx-1 p-1 space-x-2 bg-green-600 h-7 rounded text-center'>
            <p>Read More...</p>
