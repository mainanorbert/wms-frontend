    ...
    <div className='flex w-full justify-center md:pl-[4rem] mt-4'>
      <div className='md:grid md:grid-cols-3 gap-2 w-full md:space-y-0 ml-10 md:ml-0 space-y-2 '>
        ...
        <Link to='/members'>
          ...
          <div className='flex p-1 justify-start space-x-4 border hover:text-neutral-300 bg-green-400 md:text-lg font-bold items-align bg-purple-900 text-neutral-400'>
            <p className='par'>Over</p>
            <p className='rounded-full border  border-color-white md:py-3 p-1 border-2 text-center'>2000</p>
            <p className='par text-center'>Registered</p>
          </div>
          <div className='flex justify-start bg-green-600 hover:text-neutral-200 space-x-1 text- font-bold items-align bg-purple-700 text-neutral-400'>
        ...
        <motion.div
          ...
          <div>
            <div className='list-disc px-1 list-disc text-neutral-200 '>
              <li>Donation by Grants</li>
              <li>Give Cash to Support a Life</li>
              <li>Give Cash in Hard Times</li>
              <div  className='font-bold flex mt-4 justify-center space-x-2 bg-green-600 h-8 rounded text-center'>Ongoing Donations
        ...
        <motion.div
          ...
          initial="initial"
          whileHover="hover"
          className='w-8/12  h-[18rem] w-4/12 bg-purple-700'>
          <h3 className='flex p-1 justify-center text-neutral-200'>
            <img src={mem} alt="" />
          </h3>

          <div className='list-disc p-2 text-neutral-200'>
            <li>Accountability</li>
            <li>No handling of Cash</li>
            <li>Access to financial Records</li>
            <li>Efficient Management</li>
          </div>
          <div  className='font-bold flex mb-1 text-neutral-300 font-bold justify-center mx-1 p-1 space-x-2 bg-green-600 h-7 rounded text-center'>
          <p>Read More...</p>
