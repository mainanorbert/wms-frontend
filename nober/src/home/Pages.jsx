      ...
      <div className='md:grid md:grid-cols-3 gap-2 w-full md:space-y-0 ml-10 md:ml-0 space-y-2 '>
        ...
        <div className='wel bg-purple-900 w-8/12 h-[18rem] rounded-xl'>
          <Link to='/members'>
            ...
            <div className='flex p-1 justify-start space-x-4 border hover:text-neutral-300 md:text- font-bold items-align bg-purple-900 text-neutral-400'>
            ...
            <div className='flex justify-start md:mt-5 mt-8 hover:text-neutral-200 space-x-1 text- font-bold items-align bg-purple-700 text-neutral-400'>
