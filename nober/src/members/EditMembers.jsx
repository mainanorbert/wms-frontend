...
const EditMembers = () => {
    ...
    return (
       ...
       <div className='mb-2'> <NavBar/></div>
            ...
            <div className='w-full py- flex justify-center h-screen  '>
                <form
                    onSubmit={handleSubmit}
                    className=' md:w-4/12 w-10/12 p-2 border my-  bg-purple-700'>
                    ...
                    <div className='flex justify-between'>
                        <button className='bg-green-400 w-6/12 text-neutral-200 font-bold h-6 rounded-xl'>Update</button>
                    </div>
                </form></div>
