        ...
        <div className='bg-purple-500 h-screen overflow-y-scroll'>
            ...
            <div className=''>
                ...
                <div className='flex items-center space-x-10'>
                    <div className='flex space-x-2 w-8/12 pt-7 md:justify-center justify-between items-center'>
                        <motion.div
                            whileHover={{
                                scale: [1, 1.2, 1.2, 1, 1],
                        ...
                        ><img
                            ...
                            /></motion.div>
                        <div className='text-xl font-bold text-3xl text-neutral-200 hover:text-neutral-100'>Know Your Welfare Manager!</div>
                    </div>
                        ...
                        <div className='md:grid space-y-3 grid-cols-3 gap-1 place-content-center p-2 gap-10'>
                            ...
                            <div className='border p-1'>
                                <div>
                                    ...
                                    <p className='text-neutral-200'>Check the Contribution regularly for running contributions</p>
                                </div>
                            </div>
                ...
                <div className=' mt-4'>
                    <h1 className='text-center font-bold text-xl  text-yellow-200'>Easy Steps in Pictorial</h1>
                    <div className='md:flex space-y-10 p-2 justify-around'>
                        <div>
                            <p className='text-yellow-200 flex justify-between  mb-4 font-bold'>Step 1: Register and login to the wms</p>
                            <img src={register} width={400} alt="" />
                        </div>
                        <div>
                            <p className='text-yellow-200 flex justify-between mb-4 font-bold'>Step 2: Confirm Membership</p>
                            <img src={membership} width={400} alt="" />
                        </div>
                        <div>
                            <p className='text-yellow-200 flex justify-between  mb-4 font-bold'>Step 3: Start Contributing</p>
                ...
                <div className='mt-10' id='developer'>
                    <div className='text-center font-bold text-3xl  text-yellow-200'>Hire Me!</div>
                    <div className='bg-purple-800  text-neutral-200 flex justify-center'>
                                ...
                                <div>
                                    ...
                                    <div className='md:flex justify-around'>
                                        ...
                                        <div>
                                            ...
                                            <ul>
                                            <div className='text-neutral-700 text-center rounded hover:underline'><a href='https://github.com/mainanorbert/wms-frontend'>Frontend</a> </div>
                                          <div className='text-neutral-700 text-center rounded hover:underline'>  <a 
                                          target={'_blank'}
